#!/bin/bash
#SBATCH --job-name=dsr_hlp_12k
#SBATCH --output=dsr_hlp_12k.out
#SBATCH -p batch
#SBATCH --nodes=1
...
run_name=${DSR_HLP_12K_RUN_NAME}

init_model_folder=deepscaler_1_5_b_preview_with_pad_token_in_tokenizer
init_model_path=$main_output_dir/$init_model_folder
train_test_folder=${RL_PARQUET_DATASETS}/aime_2024_standard_prompt_with_special_tokens
...
python3 -u -m recipe.dapo.main_dapo \
    ...
    +reward_model.use_deepscaler_reward=True \
    +reward_model.correct_and_no_format_reward=1.0 \
