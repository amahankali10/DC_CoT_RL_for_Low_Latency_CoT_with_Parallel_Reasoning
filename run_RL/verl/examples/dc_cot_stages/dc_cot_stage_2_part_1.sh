#!/bin/bash
#SBATCH --job-name=dc_cot_stage_2_part_1
#SBATCH --output=dc_cot_stage_2_part_1.out
#SBATCH -p batch
#SBATCH --nodes=1
...
run_name=${RL_STAGE2_PART1_NAME}

prev_RL_project=${RL_WANDB_PROJECT}
prev_RL_run_name=${RL_STAGE1_NAME}
prev_RL_step=global_step_700
...
python3 -u -m recipe.dapo.main_dapo \
    ...
    actor_rollout_ref.actor.optim.lr=1.414e-6 \
