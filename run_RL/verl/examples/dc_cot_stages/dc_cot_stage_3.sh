#!/bin/bash
#SBATCH --job-name=dc_cot_stage_3
#SBATCH --output=dc_cot_stage_3.out
#SBATCH -p batch
#SBATCH --nodes=1
...
run_name=${RL_STAGE3_NAME}

prev_RL_project=${RL_WANDB_PROJECT}
prev_RL_run_name=${RL_STAGE2_PART2_NAME}
prev_RL_step=global_step_280
